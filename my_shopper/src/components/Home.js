...
class Home extends React.Component {
    ...
    componentDidUpdate(prevProps,prevState ){
        ...
        axios.get('https://fakestoreapi.com/products/category/'+this.state.catname)
        .then(res => {
            ...
            <section>
                <div class="container">
                    <div class="row">
                        ...
                        <div>
                        <input type="text" ref={this.x1} className="form-control"/>
                                            ...
                                            <div class="product-image-wrapper">
                                                ...
                                                <div class="choose">
                                                    <ul class="nav nav-pills nav-justified">
                                                        ...
                                                        <li><Link to={'/singlePage/'+val.id}><i clLinkss="fa fa-plus-square"></i>Add to compare</Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
